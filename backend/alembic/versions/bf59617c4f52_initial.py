...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_securities_symbol"), "securities", ["symbol"], unique=False
    )
    op.create_table(
        "accounts",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_security_aliases_alias_symbol"),
        "security_aliases",
        ["alias_symbol"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["detected_institution_id"],
            ["institutions.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "user_id", "file_hash", name="uq_import_sessions_user_hash"
        ),
    )
    op.create_index(
        op.f("ix_import_sessions_file_hash"),
        "import_sessions",
        ["file_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_import_sessions_status"), "import_sessions", ["status"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "records_extracted", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_parser_runs_import_session_id"),
        "parser_runs",
        ["import_session_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_reconciliation_records_import_session_id"),
        "reconciliation_records",
        ["import_session_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_reconciliation_records_status"),
        "reconciliation_records",
        ["status"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "unrealized_gain_pct", sa.Numeric(precision=8, scale=4), nullable=True
        ),
        sa.Column(
            "raw_source_ref", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_holdings_security_id"), "holdings", ["security_id"], unique=False
    )
    op.create_table(
        "transactions",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_transactions_security_id"),
        "transactions",
        ["security_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_dividends_account_id"), "dividends", ["account_id"], unique=False
    )
    op.create_index(
        op.f("ix_dividends_security_id"), "dividends", ["security_id"], unique=False
    )
    op.create_table(
        "fees",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "quantity_original", sa.Numeric(precision=18, scale=8), nullable=False
        ),
        sa.Column(
            "quantity_remaining", sa.Numeric(precision=18, scale=8), nullable=False
        ),
        ...
        sa.Column(
            "wash_sale_disallowed", sa.Numeric(precision=18, scale=4), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_reconciliation_records_status"), table_name="reconciliation_records"
    )
    op.drop_index(
        op.f("ix_reconciliation_records_import_session_id"),
    ...
    op.drop_index(
        op.f("ix_security_aliases_alias_symbol"), table_name="security_aliases"
    )
